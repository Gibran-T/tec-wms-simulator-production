...
export const M1_MISSIONS: Record<number, MissionData> = {
  ...
  5: {
    ...
    context: "Deux anomalies : (1) GR-2025-004 non postée pour SKU-004 (30 u.). (2) Écart inventaire SKU-005 (−8 u.) au comptage cyclique. Ordre : Documents → Physique → Réconciliation inventaire.",
    ...
    controlPoints: [
      ...
      "PUTAWAY SKU-004 et SKU-005, puis comptage cyclique SKU-005.",
      "Cycle Count + ADJ pour SKU-005, puis Conformité.",
    ],
    studentActions: [
      "1) Poster GR-2025-004 (MIGO) — SKU-004, 30 u., REC-01.",
      "2) PUTAWAY SKU-004 (REC-01 → B-01-R1-L1) et SKU-005 (REC-02 → B-01-R1-L2).",
      "3) Cycle Count SKU-005 à B-01-R1-L2 : quantité physique 52 (système 60, écart −8).",
      "4) ADJ (MI07) −8 pour l'écart, puis Conformité.",
    ],
    ...
    demoGuidance: "Ordre : Documents → Physique → Réconciliation inventaire.",
    evalGuidance: "Ordre strict — ghost GR avant putaway SKU-004 ; CC/ADJ SKU-005 sans expédition.",
    recoveryPaths: ["Post GR-004 → putaway both → CC SKU-005 → ADJ −8 → COMPLIANCE"],
