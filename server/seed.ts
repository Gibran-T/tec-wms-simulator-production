...
async function seed() {
  ...
  const m5BaseContract = {
    ...
    initialStockQty: 0,
    storageCapacity: 100,
    operationalWindow: "Quart de clôture Peak Week — fenêtre ops continue",
    priorityRequirement: {
      customerCode: "CLI-PRIORITAIRE-A",
      reservedQty: 10,
      note: "Protéger la disponibilité minimale (10 u.) pour CLI-PRIORITAIRE-A sans désorganiser le flux inbound.",
    },
    kpiData: m5KpiSeed,
  ...
  const m5Scenarios = [
    {
      moduleId: m5.id,
      name: "SCN-015 — Protéger une commande prioritaire sans désorganiser le flux",
      descriptionFr: "Quart de clôture 1/3 : exécuter le cycle nominal, protéger le minimum prioritaire, accepter Q = 0 sans correction artificielle.",
      descriptionEn: "Closing shift 1/3: run the nominal cycle, protect the priority minimum, accept Q = 0 without artificial correction.",
      difficulty: "moyen" as const,
      isActive: true,
      initialStateJson: {
        m5Contract: {
        ...
        context: "Peak Week mission 1/3 — priorité CLI-PRIORITAIRE-A · inbound 50 · Min 10 · Q=0 attendu",
        module: 5,
      },
      createdBy: 1,
    },
    {
      moduleId: m5.id,
      name: "SCN-016 — Réconcilier avant de décider",
      descriptionFr: "Quart de clôture 2/3 : écart −5 (50→45), ajustement obligatoire, puis Q = 0 sur stock corrigé.",
      descriptionEn: "Closing shift 2/3: variance −5 (50→45), mandatory adjustment, then Q = 0 on corrected stock.",
      difficulty: "difficile" as const,
      isActive: true,
      initialStateJson: {
        m5Contract: {
        ...
        context: "Peak Week mission 2/3 — variance −5 @ B-01-R1-L1 ; ADJ requis avant décision",
        module: 5,
      },
      createdBy: 1,
    },
    {
      moduleId: m5.id,
      name: "SCN-017 — Présenter le bilan du quart et défendre le prochain plan d'action",
      descriptionFr: "Quart de clôture 3/3 : défendre le bilan avec ≥3 preuves de session (pas le portfolio M4).",
      descriptionEn: "Closing shift 3/3: defend the shift review with ≥3 session evidence items (not the M4 portfolio).",
      difficulty: "difficile" as const,
      isActive: true,
      initialStateJson: {
        m5Contract: {
        ...
        context: "Peak Week mission 3/3 — bilan du quart · preuves de session · portes stratégiques",
        module: 5,
      },
      createdBy: 1,
    },
