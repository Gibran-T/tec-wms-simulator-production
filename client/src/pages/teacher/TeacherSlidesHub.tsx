...
const modules = [
  ...
  },
  {
    ...
    descFr: "Simulation opérationnelle complète intégrant tous les modules. Gestion de crise logistique, scénarios réels et clôture du parcours M5.",
    descEn: "Full operational simulation integrating all modules. Logistics crisis management, real scenarios and M5 pathway closure.",
    slides: SLIDE_COUNT_BY_MODULE[5],
    duration: "6h",
    topics: ["Simulations · Crise", "Gestion intégrée", "Module complété"],
    topicsEn: ["Simulations · Crisis", "Integrated management", "Module complete"],
    badge: "M5",
  },
];
