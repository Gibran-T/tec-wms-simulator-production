...
import { BookOpen, FlaskConical, ShieldCheck, Zap, Play, Lock, Layers, Users, GraduationCap } from "lucide-react";
    ...
    <FioriShell>
      <div className="max-w-2xl mx-auto py-10 px-4 space-y-6">
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3 text-xs text-muted-foreground flex-wrap">
                  <span className="flex items-center gap-1"><ShieldCheck className="w-3 h-3 text-blue-500" /> {t("Score officiel", "Official score")}</span>
                  ...
                  <span className="flex items-center gap-1"><GraduationCap className="w-3 h-3 text-blue-500" /> {t("Rapport de certification", "Certification report")}</span>
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <Button
            className={`gap-2 ${selectedMode === "demonstration" ? "bg-green-700 hover:bg-green-800" : "bg-blue-600 hover:bg-blue-700"}`}
