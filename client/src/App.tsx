import "./styles/tec-enterprise.css";
...
import M5DocProfessorPage from "./pages/teacher/M5DocProfessorPage";
...
import SilverCertificatePreview from "./pages/student/SilverCertificatePreview";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/teacher/m5-doc/:runId" component={M5DocProfessorPage} />
