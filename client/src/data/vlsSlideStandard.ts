...
const VLS_M4_HOTSPOTS: VlsHotspot[] = [
  ...
  },
  {
    ...
    detailFr: "2 400 ÷ 400 = 6× · 4–12× normal · <4× risque surstock · >12× risque stock trop serré · SCN-012",
    detailEn: "2,400 ÷ 400 = 6× · 4–12× normal · <4× overstock risk · >12× tight-stock risk · SCN-012",
    x: 10,
    y: 28,
    w: 16,
    h: 24,
