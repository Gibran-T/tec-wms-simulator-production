...
const VLS_M5_HOTSPOTS: VlsHotspot[] = [
  {
    ...
    labelFr: "Réception",
    labelEn: "Reception",
    detailFr: "Exécuter · point de départ du cycle intégré · SCN-015",
    detailEn: "Execute · integrated cycle starting point · SCN-015",
    x: 4,
    y: 38,
    w: 16,
    h: 22,
  },
  {
    ...
    labelFr: "Rangement",
    labelEn: "Putaway",
    detailFr: "Contrôler · traçabilité lot · flux de bout en bout",
    detailEn: "Control · lot traceability · end-to-end flow",
    x: 20,
    y: 32,
    w: 14,
    h: 20,
  },
  {
    ...
    labelFr: "Comptage",
    labelEn: "Cycle count",
    detailFr: "Vérifier · détecter un écart éventuel · SCN-016",
    detailEn: "Verify · detect possible variance · SCN-016",
    x: 36,
    y: 28,
    w: 16,
    h: 24,
  },
  {
    ...
    labelFr: "Réapprovisionnement",
    labelEn: "Replenishment",
    detailFr: "Corriger / arbitrer · Q selon stock et minimum",
    detailEn: "Correct / arbitrate · Q from stock vs minimum",
    x: 52,
    y: 30,
    w: 14,
    h: 22,
  ...
  {
    id: "kpi-monitor",
    labelFr: "Preuves de session",
    labelEn: "Session evidence",
    detailFr: "Interpréter · preuves et indicateurs de votre cycle · SCN-017",
    detailEn: "Interpret · evidence and indicators from your cycle · SCN-017",
    x: 66,
    y: 26,
    w: 16,
    h: 26,
  },
  {
    ...
    detailFr: "Décider et défendre · priorité · compromis · horizon · SCN-017",
    detailEn: "Decide and defend · priority · trade-off · horizon · SCN-017",
    x: 78,
    y: 34,
    w: 16,
    h: 22,
  },
  {
    ...
    detailFr: "Communiquer · fiabilité du cycle · parcours M1–M5",
    detailEn: "Communicate · cycle reliability · M1–M5 pathway",
    x: 70,
    y: 4,
    w: 24,
    h: 16,
...
export const VLS_MODULE_CONFIG: Record<number, VlsModuleConfig> = {
  ...
  5: {
    ...
    observationZoneKeywords: [
      "EXÉCUTER", "EXECUTE", "CONTRÔLER", "CONTROL", "CORRIGER", "CORRECT",
      "ARBITRER", "ARBITRATE", "COMMUNIQUER", "COMMUNICATE",
      "SCN-015", "SCN-016", "SCN-017", "PREUVE", "EVIDENCE", "VARIANCE",
    ],
    conceptsLabel: { fr: "Piloter et décider", en: "Steer and decide" },
    quizThresholdPct: 60,
