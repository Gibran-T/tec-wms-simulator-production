...
export const MODULE_CONFIG: ModuleConfigEntry[] = [
  ...
  },
  {
    ...
    descFr: "KPI Tower · Sélecteur cognitif 5 options · Rotation · OTIF/erreurs · Diagnostic S&OP",
    descEn: "KPI Tower · 5-option cognitive selector · Turnover · OTIF/errors · S&OP diagnosis",
    durationH: 6,
    passThreshold: 70,
    ...
    objectives: [
      { fr: "Lire les KPI Annexe A sans mouvement de stock", en: "Read Annex A KPIs without stock movement" },
      { fr: "Choisir la meilleure réponse cognitive parmi 5 near-miss", en: "Choose the best cognitive answer among 5 near-misses" },
      { fr: "Éviter les pièges (liquidation, dashboard vert, mono-KPI)", en: "Avoid traps (liquidation, green dashboard, single-KPI)" },
      { fr: "Arbitrer un diagnostic multi-KPI avec priorité, trade-off et suivi", en: "Arbitrate a multi-KPI diagnosis with priority, trade-off and follow-up" },
    ],
  },
  {
    id: 5,
