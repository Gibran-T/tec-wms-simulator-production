...
export const STEP_ERP_MAP: Record<string, StepErpHint> = {
  ...
  M5_ADJ: { erpModule: { fr: "IM — Ajustement", en: "IM — Adjustment" }, wmsFunction: { fr: "Correction écart M5", en: "M5 variance correction" }, sapTCode: "MI07", odooEquivalent: { fr: "Ajustement stock", en: "Stock adjustment" }, whyShort: { fr: "Résout l'écart avant KPI.", en: "Resolves variance before KPI." } },
