    ...
    <div className="space-y-4 text-xs">
      {pedagogy && (
        <div className="p-3 bg-primary/5 border border-primary/20 space-y-2">
          <p className="text-[10px] font-bold text-primary uppercase">{t("Preuves à observer", "Evidence to observe")}</p>
          <p className="text-[10px] text-slate-700 dark:text-slate-300">{pickLang(pedagogy.evidenceToObserve, language)}</p>
          <p className="text-[10px] font-bold text-slate-500 uppercase pt-1">{t("Problème opérationnel", "Operational problem")}</p>
          <p className="text-[10px] text-slate-600 dark:text-slate-400 italic">{pickLang(pedagogy.operationalProblem, language)}</p>
        </div>
      )}
...
function PanelD({ mission, nextStepCode, compliance, isDemo, onExecute, scnCode, t, language }: {
  ...
  return (
    <div className="space-y-3 text-xs">
      ...
      {pedagogy && (
        <p className="text-[10px] bg-slate-50 border border-slate-200 p-2 text-slate-700 dark:text-slate-300">
