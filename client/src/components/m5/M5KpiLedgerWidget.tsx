    ...
    <div className="bg-card border border-border rounded-none shadow-sm overflow-hidden" data-testid="m5-kpi-ledger">
      ...
      <div className="p-3 space-y-3">
        ...
        <p className="text-[9px] text-slate-500 italic border-t border-border pt-2">
          {t(
            "Seules les preuves dérivées du run sont affichées. Le portfolio M4 (6× / 95 % / 4 %) n'est pas une preuve de session.",
            "Only run-derived evidence is shown. The M4 portfolio (6× / 95% / 4%) is not session evidence.",
          )}
        </p>
      </div>
    </div>
