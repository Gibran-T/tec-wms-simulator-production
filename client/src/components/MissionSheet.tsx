            ...
            <div className="p-8 space-y-8 font-sans">
              ...
              {pedagogy && (
                <div className="bg-blue-50 dark:bg-blue-950/20 border-l-4 border-blue-600 p-4 space-y-3">
                  ...
                  <p className="text-[10px] text-blue-800/80 dark:text-blue-300/80 italic border-t border-blue-200/60 pt-2">
                    {t("Retenue pédagogique", "Learning takeaway")}: {pickLang(pedagogy.learningTakeaway, language)}
                  </p>
                </div>
              )}
